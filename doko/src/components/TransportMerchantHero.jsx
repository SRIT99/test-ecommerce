...
const TransportMerchantHero = () => {
  return (
    <section className="bg-white dark:bg-slate-900 text-black dark:text-white py-20 px-6">
      <div className="max-w-5xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">
          Drive the Future of Agriculture 🚚
        </h1>
        <p className="text-lg md:text-xl text-gray-700 dark:text-slate-100 mb-8">
