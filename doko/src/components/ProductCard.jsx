...
const ProductCard = ({ product }) => {
  ...
  return (
    <Link to={`/products/${product.id}`} className="block bg-white dark:bg-slate-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
      <div className="bg-white dark:bg-slate-800 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="p-4">
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-sm">Seller: {product.seller}</span>
              </div>
