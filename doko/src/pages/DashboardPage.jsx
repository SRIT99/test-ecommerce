...
import FarmerProductForm from './FarmerProductForm'; // adjust path as needed
        ...
        <div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md mb-8">
                ...
                <p className="text-slate-600 dark:text-slate-400">You have 3 pending orders to fulfill.</p>
                                <Link to="/orders">
                                    <button className="mt-4 bg-blue-600 hover:bg-blue-800 text-white py-2 px-4 rounded transition-colors">
                                        View Orders
                                    </button>
                                </Link>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold mb-4 text-primary">Add New Product</h3>
                <FarmerProductForm />
            </div>
        </div>
    );
            ...
            case 'admin':
                return (
                    <div>
                        ...
                        {/* 👇 Add this block to show merchant approvals */}
      <div className="mt-10">
