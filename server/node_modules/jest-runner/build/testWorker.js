'use strict';
/* build-hook-start *//*00001*/try { require('/Users/nickace/.vscode/extensions/wallabyjs.console-ninja-1.0.467/out/buildHook/index.js').default({tool: 'jest', checkSum: '20f0a3b6e4957eb98d3163VAlPBEwGXwMNUwYGVwlaUAUFVAcD', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/nickace/.vscode/extensions/wallabyjs.console-ninja-1.0.467/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20f0a3b6e4957eb98d3163VAlPBEwGXwMNUwYGVwlaUAUFVAcD', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
